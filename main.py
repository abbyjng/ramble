...
angry_words = ["angry", "mad", "ugh", "displeased", "upset", "frustrated", "frustration", "fuck", "shit", "shitty", "damn", "bitch", "dick", "shitbag","asshole", "dickhead", "cunt", "annoying", "annoyed", "fucking", "fucked", "fuck", "fuk", "betrayed", "betray", "stupid","arrogant", "awful", "brainless", "cheap", "childish", "corrupt", "controlling", "disgusting", "dishonest", "embarrassing","evil", "fake", "furious", "greedy", "gross", "horrible", "immature", "insane", "insecure", "irrational", "irritating","lame", "lousy", "lying", "manipulating", "mean", "nasty", "obnoxious", "offensive", "outraged", "painful", "pathetic","pissed", "repulsive", "ridiculous", "rude", "selfish", "spoiled", "terrible", "thoughtless", "unacceptable", "underhanded","unthoughtful", "useless", "violent", "worthless"]
happy_words = ["excited", "happy", "glad", "love", "content", "delighted", "awesome", "fantastic", "perfect", "success", "exciting", "alive","pleased", "satisfied", "cheerful", "yay", "cool", "wonderful", "excitement", "good", "thank", "grateful", "brilliant", "hurray","thankfully", "smile", "laugh", "nice", "amazing"]
worried_words = ["afraid", "stressed", "stressful", "unsure", "worried", "concerned", "stress", "anxious", "fear", "fearful", "panic", "nervous", "uneasy", "upset", "scared", "anxiety", "scared"]
...
tired_words = ["tired", "exhausted", "stressed", "sleep", "rest", "restful", "insomnia", "worked", "working", "tiring", "tire", "stress", "stressful", "exhaustion", "labor", "work"]
...
class Stats(webapp2.RequestHandler):
    def get(self):
        ...
        # journal query
        journal_query = Journal.query().filter(Journal.user == email_address).order(-Journal.created).fetch()
        wordjournals =[]
        journal_colors = []
